 ...
 * fixedSiteId: site id for supervisor (auto assigned)
 */
const CreateLabour = ({ role = "admin", fixedSiteId = "" }) => {
  ...
  useEffect(() => {
    ...
    if (role === "supervisor" && fixedSiteId) {
      setFormData((prev) => ({
        ...prev,
        site_id: fixedSiteId,
      }));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({
        ...
        aadhaar: "",
        address: "",
        site_id: role === "supervisor" ? fixedSiteId : "",
      });
    } catch (err) {
